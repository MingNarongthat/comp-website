...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Personal Web Project"}],"link":[{"rel":"icon","type":"image/png","href":"/favicon.jpg"}],"style":[],"script":[],"noscript":[],"title":"Personal Web"};
...
const _lazy_u499E2 = () => Promise.resolve().then(function () { return articles$1; });
const _lazy_Ygc6Jc = () => Promise.resolve().then(function () { return _id_$1; });
const _lazy_gU8Vy9 = () => Promise.resolve().then(function () { return companies$1; });
const _lazy_xcbzUv = () => Promise.resolve().then(function () { return ____path_$1; });
const _lazy_qh6Orl = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/articles', handler: _lazy_u499E2, lazy: true, middleware: false, method: undefined },
  { route: '/api/articles/:id', handler: _lazy_Ygc6Jc, lazy: true, middleware: false, method: undefined },
  { route: '/api/companies', handler: _lazy_gU8Vy9, lazy: true, middleware: false, method: undefined },
  { route: '/api/proxy/uploads/**:path', handler: _lazy_xcbzUv, lazy: true, middleware: false, method: undefined },
...
const companies = defineEventHandler(async (event) => {
  try {
    const backendUrl = false ? process.env.NUXT_PUBLIC_API_BASE || "http://localhost:8080" : "http://backend:8080";
...
const companies$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: companies
});
